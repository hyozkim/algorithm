...
public class Friends4Block {
    ...
    public static void sort(int m, int n, char[][] board, int[][] removedBoard) {
        while( true ) {
    ...
    public static int removeNsort(int m, int n, char[][] board) {
        int removeCount = 0;
    ...
    public static int solution(int m, int n, String[] board) {
        ...
        int count = -1;
        while( count != 0 ) {
            count = removeNsort(m,n,charBoard);
            answer += count;
        }
